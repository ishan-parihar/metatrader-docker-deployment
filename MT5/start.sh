...
# Remove the legacy persistent bootstrap file written by pre-hardening
# launchers.  Credentials are supplied only via the short-lived autostart.ini
# below, then retained by MT5 in its encrypted account store.
rm -f "$MT5_DIR/Config/common.ini"
